...
SUM(CASE WHEN DEPTNO = 20 THEN SAL ELSE 0 END)"DEPTHNO 20",
SUM(CASE WHEN DEPTNO = 30 THEN SAL ELSE 0 END)"DEPTHNO 30",
SUM(SAL)"TOTAL"
FROM EMP
GROUP BY JOB;

SELECT JOB, SUM("10") "DEPTNO_10", SUM("20") "DEPTNO_20", SUM("30") "DEPTNO_30", SUM(TOT) "TOT", SUM(NUM) "NUM"
FROM
(SELECT JOB,COUNT(*) "NUM",
CASE WHEN DEPTNO = '10' THEN SUM(SAL) END "10", CASE WHEN DEPTNO = '20' THEN SUM(SAL) END "20",
CASE WHEN DEPTNO = '30' THEN SUM(SAL) END "30", CASE WHEN DEPTNO IN ('10','20','30') THEN SUM(SAL) END AS "TOT" 
